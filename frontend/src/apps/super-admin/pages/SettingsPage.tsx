      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="card space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-400">
              Current: {calendarType === 'AD' ? 'Gregorian (AD)' : 'Bikram Sambat (BS)'}
            </p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {[
              { label: 'New operator registration', key: 'tenant_registration' },
              { label: 'Document expiry alerts', key: 'doc_expiry' },
              { label: 'Emergency broadcasts', key: 'emergency' },
              { label: 'Revenue threshold alerts', key: 'revenue' },
