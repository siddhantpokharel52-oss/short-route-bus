...
urlpatterns = [
    ...
    path("api/v1/billing/", include("backend.apps.billing.urls")),
    path("api/v1/platform/", include("backend.apps.platform.urls")),
    path("api/v1/public/", include("backend.apps.platform.public_urls")),
    path("api/v1/public/complaints/", include("backend.apps.complaints.public_urls")),
