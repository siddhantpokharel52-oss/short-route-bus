...
1. Get real NamastePay TEST credentials from NamastePay/NDPC (the merchant portal is login-only, no self-signup) to verify the auth-header guess in `namastepay.py` and confirm the request/response shapes against the real API.
